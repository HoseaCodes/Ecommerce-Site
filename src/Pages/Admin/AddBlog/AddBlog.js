...
const AddBlog = ()=>{
	...
	function submitCategory(event){
		...
		axios.post('/api/category', {name:inputCategory})
			.then(()=>{setNewCategory(inputCategory); setCategory(inputCategory); return setCategoryLoading(false)})
		...
		<div>
			...
			<div>
				...
				<form onSubmit={handleSubmit}>
					...
					<input required onChange={((e)=>{setSubHeading(e.target.value)})} value={subHeading} placeholder='SubHeading' />
